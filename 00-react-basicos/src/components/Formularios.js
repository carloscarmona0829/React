...
export default function Formularios(){
    ...
    const handleChange = (e) => {
        setForm({
            ...form,
            [e.target.name]:e.target.value, //con los [] se convirtió el e.target.name en propiedad del objeto
        });
    };
    ...
    const handleChecked = (e) => {
        setForm({
            ...form,
            [e.target.name]:e.target.checked, //con los [] se convirtió el e.target.name en propiedad del objeto
        });
    };
